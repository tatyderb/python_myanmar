...
Отметьте правильные способы создания пустого списка.
...
## QUIZ Добавить элемент

Есть пустой список. 
```python
a = []
```
Как в него добавить число 7?
...
## QUIZ append vs extend

Отметьте корректные выражения для `a = [1, 2, 3]`
...
b = ['hello', 'hi']
```
Отметьте выражения, которые дадут список `[1, 2, 3, 'hello', 'hi']`.
