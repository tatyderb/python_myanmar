...
### Положить минимальное число в `res` 
...
Напечатайте четное число `x` или нечетное.
...
До 10000 рублей снимается с комиссией 1%, от 1000 и выше снимается с комиссией в 5%. Округление в меньшую сторону.
